  ...
  return (
    <div>
      <div className="mint-section">
        <h1 style={{ fontFamily: "Poppins" }}>Choose your Pokemon</h1>
        <p style={{ fontFamily: "Noto Sans JP", fontSize: "1.2rem" }}>
          You can choose only 1 Pokemon.
        </p>
        <div className="pokeball-box">
          <div className="mint-box">
            <button onClick={mintNFT} className="mintBtn">
